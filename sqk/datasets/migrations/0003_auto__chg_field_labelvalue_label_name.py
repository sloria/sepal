...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabelValue.label_name'
        db.alter_column('datasets_labelvalue', 'label_name_id', self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['datasets.LabelName']))

    def backwards(self, orm):

        # Changing field 'LabelValue.label_name'
        db.alter_column('datasets_labelvalue', 'label_name_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['datasets.LabelName']))

    models = {
        'datasets.dataset': {
            'Meta': {'object_name': 'Dataset'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 10, 0, 0)'}),
        ...
        'datasets.labelvalue': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label_name': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'label_values'", 'to': "orm['datasets.LabelName']"}),
