...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Feature', fields ['name']
        db.create_unique('datasets_feature', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Feature', fields ['name']
        db.delete_unique('datasets_feature', ['name'])
