...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Instance.label'
        db.alter_column('datasets_instance', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['datasets.Label']))
    ...
    models = {
        ...
        'datasets.label': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'default': "'nolabel'", 'max_length': '100'})
        },
        'datasets.value': {
