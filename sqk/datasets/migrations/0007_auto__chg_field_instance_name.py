...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('datasets_instance', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Instance.name'
        db.alter_column('datasets_instance', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
