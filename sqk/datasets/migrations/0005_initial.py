...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('datasets_labelvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label_name', self.gf('django.db.models.fields.related.ForeignKey')(related_name='label_values', to=orm['datasets.LabelName'])),
        ...
        db.create_table('datasets_dataset', (
            ...
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 12, 11, 0, 0))),
        ))
    ...
    models = {
        'datasets.dataset': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 11, 0, 0)'}),
