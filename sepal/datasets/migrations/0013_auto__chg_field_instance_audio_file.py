...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Instance.audio_file'
        db.alter_column('datasets_instance', 'audio_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Instance.audio_file'
        db.alter_column('datasets_instance', 'audio_file', self.gf('django.db.models.fields.files.FileField')(default=0, max_length=100))
    ...
    models = {
        ...
        'datasets.instance': {
            ...
            'audio_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 23, 0, 0)'}),
