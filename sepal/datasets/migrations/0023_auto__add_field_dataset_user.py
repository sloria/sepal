...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('datasets_dataset', 'user',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('datasets_dataset', 'user_id')
    ...
    models = {
        ...
        'datasets.dataset': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)'}),
