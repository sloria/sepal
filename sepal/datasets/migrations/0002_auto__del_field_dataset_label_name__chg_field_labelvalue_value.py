...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabelValue.value'
        db.alter_column('datasets_labelvalue', 'value', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LabelValue.value'
        db.alter_column('datasets_labelvalue', 'value', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
