...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('datasets_feature', 'unit',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)


        # Changing field 'Feature.display_name'
        db.alter_column('datasets_feature', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Feature.unit'
        db.delete_column('datasets_feature', 'unit')


        # Changing field 'Feature.display_name'
        db.alter_column('datasets_feature', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'datasets.feature': {
            ...
            'display_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
