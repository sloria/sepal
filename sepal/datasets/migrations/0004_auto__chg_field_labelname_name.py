...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabelName.name'
        db.alter_column('datasets_labelname', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'LabelName.name'
        db.alter_column('datasets_labelname', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
